...
function animate() {
  ...
  const balls = [
    {r: 200, s: 2.5, blob: document.getElementById("ball-1"), ...emptyBall},
    {r: 160, s: 3.7, blob: document.getElementById("ball-2"), ...emptyBall},
    {r: 100, s: 5.0, blob: document.getElementById("ball-3"), ...emptyBall},
  ]
